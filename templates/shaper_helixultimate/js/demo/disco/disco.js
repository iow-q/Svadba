(() => {
    ...
    window.addEventListener("load", (event => {
        if (document.getElementById("wedding_day") != null && document.getElementById("clockdiv") != null) initializeClock("clockdiv");
    }));
    function initializeClock(id) {
        var endtime = document.getElementById("wedding_day").innerHTML;
